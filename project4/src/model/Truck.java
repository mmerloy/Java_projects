...
//грузовик
public class Truck extends TransportTrailer implements Serializable
{
	
	private static final long serialVersionUID = 1L;

	// вызываем конструктор родительского класса
	public Truck(int ID, String mark, String model, double maxmas, int kol, double maxspeed, Trailer trailer,

...
public class MyLogger 
{
    ...
    public static Logger LOGGER = Logger.getLogger(MyLogger.class.getName());/** logger для записи в  log*/
    public static Scanner sc = new Scanner(System.in); /** scanner для чтения из консоли*/
    public static FileHandler fh;  /** fileHandler для записи в файл */
     ...
     */
    public static void Log(String msg, Level level,String outLogFile)
    {
        try
        {
